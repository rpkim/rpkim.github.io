...
//$request = 'http://map.naver.com/findroute2/findCarRoute.nhn?via=&call=route2&output=json&car=0&mileage=12.4&start=126.7051511,37.4560537,dfsdfsf&destination=126.7249104,37.5008313,sdfasdfsf&search=5';

$request = 'http://map.naver.com/findroute2/findCarRoute.nhn?via=&call=route2&output=json&car=0&mileage=12.4&start='.$xpos.','.$ypos.','.$from.'&destination='.$xpos1.','.$ypos1.','.$to.'&search=5';
