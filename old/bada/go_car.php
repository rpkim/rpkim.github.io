...
$request = 'http://map.naver.com/findroute2/findCarRoute.nhn?via=&call=route2&output=json&car=0&mileage=12.4&start='.$xpos.','.$ypos.','.urlencode($from).'&destination='.$xpos1.','.$ypos1.','.urlencode($to).'&search=2';
...
if($congestion2 == "")
{
	echo '<congestion2>0</congestion2>';
}
else
{
...
if($congestion3 == "")
{
	echo "<congestion3>0</congestion3>";
}
else
{
